...
const OpenMailboxScreen = ({ emailInput }) => {
  return (
    <div className="open-mailbox-screen-container">
      <div className="open-mailbox-screen-content">
        ...
        <div className="open-mailbox-screen-description">
          We've sent an email for you at {emailInput}. It has a magic link that
          will sign you in right away
        </div>
